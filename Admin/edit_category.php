...
?>
   ...
   <h3 class="text-center text-success mt-4">Edit Category</h4>
    <form action="" method="post" class="text-center">
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="category_title" class="form-label fw-bold mb-4 mt-4" style="padding-right:500px;">Category Title :</label>
        ...
        <div class="form-outline">
            <input type="submit" name = "edit_cat" value="Update Category" class="btn btn-info px-3 mb-4 mt-2">
        </div>
    </form>
<br><br><br>