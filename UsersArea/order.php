<?php
        ...
        while($row_price=mysqli_fetch_array($result_cart)){
            ...
            $select_product = "Select * from `products` where product_id = $product_id or product_title = '$product_title'";
        ...
        // $product_title = $select_products['product_title']; 
        
        // $product_title = $row_product_price[];
