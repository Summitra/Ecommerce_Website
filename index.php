  ...
  <img src = "./images/logo.png" alt="" class="logo"></img>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" style="padding-left:20px;" aria-current="page" href="index.php">Home</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="cart.php"><i class="fa-sharp fa-solid fa-cart-shopping"></i><b><sup><?php cart_item();?></sup></b></a>
        </li>
